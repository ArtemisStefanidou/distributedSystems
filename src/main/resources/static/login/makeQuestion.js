class QuestionPost {
    constructor(question_id,question_image, question_text, question_option1, question_option2, question_option3, question_option4, question_script,question_teacher_id,lvl) {
...
document.getElementById("makeQuestion").addEventListener("click", (event) => {
    ...
    const questionPost = new QuestionPost(1,'image', 'test', 'opt1', 'opt2', 'opt3', 'opt4' , 'script',1,1);
